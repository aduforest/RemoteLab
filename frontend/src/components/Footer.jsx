...
<footer className="bg-white dark:bg-gray-900 mt-20">
    <div className="mx-auto w-full max-w-screen-xl p-4 py-10 lg:py-8">
      ...
      <div className="sm:flex sm:items-center sm:justify-between">
          <span className="text-sm text-gray-500 sm:text-center dark:text-gray-400">© 2024 <a href="https://www.al-enterprise.com/" className="hover:underline">Alcatel-Lucent Enterprise®</a>. All Rights Reserved.
          </span>
